...
import pylab
import numpy as np
from reinforcement_learning_ml_training_server.reinforce.environment import Env
...
class ReinforceAgent:
    ...
    def optimizer(self):
        ...
        # action, output 모두 에피소드 길이만큼 존재하고 있는 텐서다
    ...
    def discount_rewards(self, rewards):
        # rewards 라는 리스트와 같은 모양을 가진, 0으로 초기화된 배열을 생성
