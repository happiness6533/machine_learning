...
class CONFIG:
    ...
    VGG_MODEL = 'trained/imagenet-vgg-verydeep-19.mat' # Pick the VGG 19-layer model by from the paper "Very Deep Convolutional Networks for Large-Scale Image Recognition".
...
def load_vgg_model(path):
    ...
    The last few fully connected projects are not used.
