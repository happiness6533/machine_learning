...
from faceRecognitionProject.fr_utils import *
from faceRecognitionProject.inception_blocks_v2 import *
...
# a와 p 사이의 거리는 작고 a와 n 사이의 거리는 멀도록 만드는 삼중손실함수
...
# 모델을 불러오고 사전으로 {인물-128벡터} 데이터베이스를 생성한다
